...
SELECT shop_table.shop_num, order_table.order_num, content_table.content_number, goods_table.goods_name, shopper_table.shopper_name, shopper_table.shopper_num, goods_table.goods_num, order_table.order_time, goods_picture, order_table.order_address, content_status, goods_price
  FROM shopper_table, order_table, content_table, inventory_table, shop_table, goods_table
 WHERE shopper_table.shopper_num = order_table.shopper_num
   AND order_table.order_num = content_table.order_num
   AND content_table.goods_num = inventory_table.goods_num
