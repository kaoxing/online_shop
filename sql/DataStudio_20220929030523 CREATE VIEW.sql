...
CREATE VIEW shopper_order_view (shopper_num,order_num,content_number,goods_name,shop_name,shop_num) AS
SELECT shopper_table.shopper_num, order_table.order_num, content_table.content_number, goods_table.goods_name, shop_table.shop_name, shop_table.shop_num
